...
import { createColumns } from "./matsTable/columns";
import { DataTable } from "./matsTable/data-table";
import IfcViewer from "./OpenCompanyViewer";
  ...
  const [models, setModels] = useState([
    {
      ...
      dataUrl: "http://localhost:8000/api/geometry/2",
      elements: 124,
    },
    {
      id: 1,
      ...
      path: "/ifc/adv.ifc",
      dataUrl: "http://localhost:8000/api/geometry/1",
      elements: 907,
    },
  ]);
          ...
          <div className="mb-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden h-[50vh]">
              <IfcViewer
                ...
                modelPath={modelPath}
                key={`model-${activeModelId}`} // Force re-render when model changes
              />
            </div>
          </div>
